      ...
      <Card className="p-6 hover:shadow-lg transition-shadow">
        ...
        <div className="grid gap-4">
          <div className="flex items-center gap-3 group">
            ...
            <p>Επιλέξτε την κατηγορία του έργου σας</p>
          </div>
          <div className="flex items-center gap-3 group">
            <div className="p-2 rounded-lg bg-primary/5 text-primary group-hover:bg-primary/10 transition-colors">
              <MapPin size={20} />
            </div>
            <p>Προσδιορίστε την τοποθεσία του έργου</p>
          </div>
          <div className="flex items-center gap-3 group">
            <div className="p-2 rounded-lg bg-primary/5 text-primary group-hover:bg-primary/10 transition-colors">
              <FileText size={20} />
            </div>
            <p>Περιγράψτε τις απαιτήσεις του έργου σας</p>
          </div>
          <div className="flex items-center gap-3 group">
            <div className="p-2 rounded-lg bg-primary/5 text-primary group-hover:bg-primary/10 transition-colors">
              <UserRound size={20} />
            </div>
            <p>Συμπληρώστε τα στοιχεία επικοινωνίας σας</p>
          </div>
          <div className="flex items-center gap-3 group">
            <div className="p-2 rounded-lg bg-primary/5 text-primary group-hover:bg-primary/10 transition-colors">
              <CheckCircle size={20} />
            </div>
            <p>Επιβεβαιώστε τα στοιχεία σας</p>
          </div>
        </div>
      </Card>
